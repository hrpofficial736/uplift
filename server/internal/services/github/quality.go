...
func CheckForQuality(owner string, repo string) ([]interface{}, error) {
	...
	readmeCheckResponse, err := CallGithubApi(readmePath, "GET")
	if err != nil {
	...
	contributingResponse, err := CallGithubApi(contributingPath, "GET")
	if err != nil {
	...
	codeOfConductResponse, err := CallGithubApi(codeOfConductPath, "GET")
	if err != nil {
	...
	licenseResponse, err := CallGithubApi(licensePath, "GET")
	if err != nil {
	...
	gitIgnoreResponse, err := CallGithubApi(gitIgnorePath, "GET")
	if err != nil {
